...
plt.savefig(f"{WORKDIR}/Results/Paper/SupplementaryFigure2.pdf", bbox_inches="tight", dpi=300)
plt.savefig(f"{WORKDIR}/Results/Paper/SupplementaryFigure2.png", bbox_inches="tight", dpi=300)
plt.show()
plt.close()
